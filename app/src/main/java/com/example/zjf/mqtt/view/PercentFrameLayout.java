package com.example.zjf.mqtt.view;
...
public class PercentFrameLayout extends ViewGroup{
    ...
    public void setPosition(int[] percents) {
        if(percents.length==4) {
            this.xPercent = percents[0];
            this.yPercent = percents[1];
            this.widthPercent = percents[2];
            this.heightPercent = percents[3];
        }
    }
    @Override
